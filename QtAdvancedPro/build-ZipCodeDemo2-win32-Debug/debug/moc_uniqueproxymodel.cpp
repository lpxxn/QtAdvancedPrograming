/****************************************************************************
** Meta object code from reading C++ file 'uniqueproxymodel.h'
**
...
#include "../../ZipCodeDemo1/uniqueproxymodel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'uniqueproxymodel.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UniqueProxyModel_t, stringdata) + ofs \
...
const QMetaObject UniqueProxyModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_UniqueProxyModel.data,
      qt_meta_data_UniqueProxyModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UniqueProxyModel.stringdata))
